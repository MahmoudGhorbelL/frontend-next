...
import { fetchArticlesPaginationFilter } from "@/services/BookService";
import TablePagination from '@mui/material/TablePagination';
async function getProducts(page, rowsPerPage, searchTerm, prixMax) {
    page++
    const data = await
        fetchArticlesPaginationFilter(page, rowsPerPage, searchTerm, prixMax);
    return data;
}
            ...
            <div className="col-sm-3 mt-5">
                <div className="input-group mb-3">
                    <div className="input-group-prepend">
                        <span className="input-group-text" id="basic-addon1">Filtre
                            description</span>
                    </div>
                ...
                <div className="input-group mb-3">
                    <div className="input-group-prepend">
                        <span className="input-group-text" id="basic-addon2">Prix
                            Max {prixMax} </span>
                    </div>
                    <input
                        type="range"
